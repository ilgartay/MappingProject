...
<!--
  Agirlikli isi haritasi - konum analizi icin.

  Sade isi haritasindan farki weightAttr: noktalar esit sayilmiyor,
  kullanicinin kategorisine verdigi puan kadar agirlik tasiyorlar.
...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>poi_isi_agirlikli</Name>
    <UserStyle>
      <Title>POI - agirlikli isi haritasi</Title>
      <FeatureTypeStyle>
        <Transformation>
          <ogc:Function name="vec:Heatmap">
            ...
            <!--
              weightAttr: her nokta esit degil, kendi "agirlik" kolonu kadar
              isitiyor. Kullanicinin kriterlere verdigi 100 uzerinden puan
              vw_poi_agirlikli view'inda bu kolona yaziliyor; boylece puani
              yuksek kategori haritayi daha cok etkiliyor.
            -->
            <ogc:Function name="parameter">
              <ogc:Literal>weightAttr</ogc:Literal>
              <ogc:Literal>agirlik</ogc:Literal>
            </ogc:Function>
